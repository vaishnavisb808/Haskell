module SpiceFile where
import qualified Data.Map as Map
data Spice = Turmuric | Chilli | Pepper | Chicken_masala deriving (Show, Ord, Eq)
...
spices :: [Spice]
spices = [Turmuric ,Chilli ,Pepper, Chicken_masala]

values :: [(Int,Double)]
values = [(10,1.0),(20,2.5),(30,3.5),(40,4.5),(0,5.5)]


spicecatalog :: Map.Map Spice (Int, Double)
spicecatalog = Map.fromList (zip spices values)

getSpiceData:: Spice -> Map.Map Spice(Int, Double)->Maybe(Int,Double)
